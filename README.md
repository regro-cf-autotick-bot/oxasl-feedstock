...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/oxasl-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12837&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/oxasl-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `oxasl` can be installed with:

```
conda install oxasl
```

It is possible to list all of the versions of `oxasl` available on your platform with:
